...
const PACKAGES = [
    { name: "Space Only", price: "$350", period: "/hr", desc: "Book the studio, bring your vision, and walk away with raw files to edit on your own.", features: ["Studio rental access", "Professional equipment", "Raw file delivery", "Flexible scheduling", "Sound-treated room"], popular: false },
    { name: "Production Partner", price: "$1,200", period: "/hr", desc: "We film your session and our team handles editing, sound mixing, and color grading.", features: ["Everything in Space Only", "Professional filming", "Sound mixing & color grading", "2 rounds of revisions", "Delivery within 7 days"], popular: true },
    { name: "Full Service", price: "$2,000", period: "/hr", desc: "We handle everything — filming, editing, sound, thumbnails, social cuts, and distribution-ready exports.", features: ["Everything in Production Partner", "Custom thumbnails & social cuts", "Distribution-ready exports", "YouTube optimization", "Unlimited revisions"], popular: false },
    { name: "Online Appearance", price: "$600", period: "/hr", desc: "Record remotely with professional-grade quality. We handle the tech so you can focus on the conversation.", features: ["Remote recording setup", "Professional audio optimization", "Screen & camera capture", "Post-production editing", "Delivery within 5 days"], popular: false },
];
