        ...
        >
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
            ...
            <motion.div variants={stagger} initial="hidden" animate={!loading ? "visible" : "hidden"} className="relative z-10">
              ...
              <motion.p variants={fadeUp} custom={1.5} className="mt-4 flex items-center gap-2 text-sm font-medium" style={{ color: "var(--brand-orange)" }}>
                <Film size={18} /> Coming Soon: Cast on Daymond John&apos;s Next Level CEO — Inside Success TV
              </motion.p>
              <motion.p variants={fadeUp} custom={1.7} className="mt-2 flex items-center gap-2 text-sm font-medium" style={{ color: "var(--brand-orange)" }}>
                <Sparkles size={18} /> 1 Free Guest Spot Every Month — <a href="/contact" className="underline font-semibold">Join the Waitlist</a>
              </motion.p>
